...
import { Platform, View, ScrollView, Text, StatusBar, SafeAreaView, Card } from 'react-native';
import LinearGradient from 'react-native-linear-gradient';
import Carousel, { Pagination } from 'react-native-snap-carousel';
import { sliderWidth, itemWidth } from '../CarouselUtils/SliderEntry.style';
import SliderEntry from '../CarouselUtils/SliderEntry';
import styles, { colors } from '../CarouselUtils/Index.style';
import { ENTRIES1, ENTRIES2 } from '../CarouselUtils/Entries';
//import { scrollInterpolators, animatedStyles } from '../CarouselUtils/Animation';
...
export default class example extends PureComponent {
    ...
    layoutExample (number, title, type) {
        ...
        return (
            <View style={[styles.exampleContainer, isTinder ? styles.exampleContainerDark : styles.exampleContainerLight]}>
                ...
                <Carousel
                  ...
                  renderItem={isTinder ? this._renderLightItem : this._renderLightItem}
                  sliderWidth={sliderWidth}
                  itemWidth={itemWidth}
                  containerCustomStyle={styles.slider}
                  contentContainerCustomStyle={styles.sliderContentContainer}
     ...
     _renderItemTest = ({item, index}) => {
        return (
            <View style={{ backgroundColor:'#fff', padding:40, borderRadius: 25, marginTop:40 }}>
    ...
    render () {
        ...
        const example9 = this.testCarousel(5, 'Carousel Test', 'Testing Carousel');
